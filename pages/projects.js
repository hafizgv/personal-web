        ...
        <>
            ...
            <div className='flex flex-col items-center gap-5 py-20 text-white max-w-5xl m-auto text-sm lg:text-base px-10 sm:px-20'>
                <div id='projects' className='w-full'>
                    ...
                    <p className='mt-2'>Here's all my projects from small projects to... I don't think I've made big projects yet. Also you can checkout my Graphic Design Portofolio on <Link className='hover:text-red-400' href='https://www.facebook.com/hafiz.gv/' target='_blank'>Pinterest</Link></p>.
